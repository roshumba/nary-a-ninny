...
-- CreateIndex
CREATE UNIQUE INDEX "Lecture_code_key" ON "Lecture"("code");
...
-- AddForeignKey
ALTER TABLE "Question" ADD CONSTRAINT "Question_insightId_fkey" FOREIGN KEY ("insightId") REFERENCES "Insight"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Insight" ADD CONSTRAINT "Insight_lectureId_fkey" FOREIGN KEY ("lectureId") REFERENCES "Lecture"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
